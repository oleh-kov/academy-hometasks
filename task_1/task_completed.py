...
Версія: виконання з кількома логічними помилками.
"""
...
average_score = round(
    sum(student["score"] for student in students) / len(active_students),
    2,
)
...
best_student = min(students, key=lambda student: student["score"])
