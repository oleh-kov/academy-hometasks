...
-- Версія: виконання з 5 логічними помилками
...
SELECT c.category_name, COUNT(p.product_id) AS total_in_stock
...
SELECT o.order_id, SUM(oi.unit_price) AS order_total
FROM orders AS o
